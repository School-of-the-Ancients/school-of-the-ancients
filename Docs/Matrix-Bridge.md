...
Still pending: real Unity/Quest end-to-end acceptance, hosted-browser companion pairing, complete prepared checkpoint/scene restoration, content preparation/import, camera capture through the client API, voice, avatar and learning assessment. Each remains independently optional; no unavailable capability is simulated as live success.
